...
using HospitalManagement.Business.Tests.DependencyInjection;
...
namespace HospitalManagement.Business.Tests
{
    ...
    {
        public BusinessTestModule(BusinessEntityFrameworkModule abpProjectNameEntityFrameworkModule)
        {
        ...
        public override void PreInitialize()
        {
            ...
            RegisterFakeService<AbpZeroDbMigrator<BusinessDbContext>>();
