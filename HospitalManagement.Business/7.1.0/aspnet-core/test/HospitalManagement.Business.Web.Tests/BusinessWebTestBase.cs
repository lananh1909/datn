...
{
    public abstract class BusinessWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BusinessWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BusinessWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BusinessDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BusinessDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BusinessDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BusinessDbContext, Task<T>> func)
        {
            T result;
