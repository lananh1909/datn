...
namespace HospitalManagement.Auth.Migrations
{
    ...
    [Migration("20220510062217_InitDatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HospitalManagement.Auth.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HospitalManagement.Auth.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("HospitalManagement.Auth.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("HospitalManagement.Auth.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("HospitalManagement.Auth.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("HospitalManagement.Auth.Authorization.Roles.Role", b =>
                {
                    b.HasOne("HospitalManagement.Auth.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("HospitalManagement.Auth.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("HospitalManagement.Auth.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
