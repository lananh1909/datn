...
namespace HospitalManagement.Auth.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = AuthConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
