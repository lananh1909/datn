...
namespace HospitalManagement.Auth.Authorization.Users
{
    public class UserRegistrationManager : DomainService
    {
        ...
        public async Task<User> RegisterAsync(string name, string surname, string phoneNumber, string emailAddress, string userName, string plainPassword, bool isEmailConfirmed)
        {
            //CheckForTenant();
