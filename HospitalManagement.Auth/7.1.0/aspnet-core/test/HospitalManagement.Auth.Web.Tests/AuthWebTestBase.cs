...
{
    public abstract class AuthWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AuthWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AuthWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AuthDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AuthDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AuthDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AuthDbContext, Task<T>> func)
        {
            T result;
